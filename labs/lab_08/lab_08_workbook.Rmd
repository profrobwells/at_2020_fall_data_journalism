...
#There's a blank row in the dataset. There's another row that says "not included."
# for about 10 rows, there's an asterisk instead of a number
#lastly, the numbers are characters, not integers
```
