...
covid_maryland_death_jun_aug_pct_change <- covid_county_monthly_death_rate %>%
  select(county, state, d_2020_06_30, d_2020_08_30) %>%
  filter(state == "Maryland") %>%
  mutate(covid_maryland_death_jun_aug_pct_change = (d_2020_08_30 - d_2020_06_30)/d_2020_06_30) %>%
  arrange(desc(covid_maryland_death_jun_aug_pct_change))
# Write the name of the object you just created below so it displays below in the markdown document
covid_maryland_death_jun_aug_pct_change
